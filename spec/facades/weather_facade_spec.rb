...
RSpec.describe WeatherFacade do
  it 'gets search results', :vcr do
    ...
    search_results = WeatherFacade.new(location).formatted_weather_info[:data]
  ...
  # xit 'has the correct format', :vcr do Fix this if you have time 
  #   location = 'Denver, CO'
  #   expected_result = {
  #     'data':  {
  #       'id': nil,
  ...
  #   search_results = WeatherFacade.new(location).formatted_weather_info
